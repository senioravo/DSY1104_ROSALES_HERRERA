...
describe('PersonalizeForm - Tests Básicos', () => {
    let container, root;
    ...
    it('debería poder renderizar un componente React simple', (done) => {
        ...
        setTimeout(() => {
            ...
            expect(element && element.textContent).toBe('PersonalizeForm Test Content');
            done();
        }, 10);
    });
    ...
    it('debería manejar props correctamente', (done) => {
        ...
        root.render(React.createElement(TestComponent, { message: 'Hello Jasmine from PersonalizeForm' }));
        ...
        setTimeout(() => {
            ...
            expect(element).not.toBeNull();
        expect(element.textContent).toBe('Hello Jasmine from PersonalizeForm');
            done();
        }, 10);
    });
}); 
