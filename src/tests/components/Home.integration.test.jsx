...
describe('Home.integration - Tests Básicos', () => {
    let container, root;
    ...
    it('debería manejar props correctamente', (done) => {
        ...
        root.render(React.createElement(TestComponent, { message: 'Hello Jasmine from Home.integration.test.jsx' }));
        ...
        setTimeout(() => {
            ...
            expect(element).not.toBeNull();
        expect(element.textContent).toBe('Hello Jasmine from Home.integration.test.jsx');
            done();
        }, 10);
    });
